...
Pinsource is distributed as a Debian package. Download the latest `.deb` from the [releases page](https://github.com/alaudet/pinsource/releases) and install with:
